...
<nav class="relative px-4 py-4 flex justify-between items-center">
    ...
    <ul id="navbar-menu"
        class=" burger-width justify-center hidden absolute mt-6 top-1/2 left-1/2 gap-12 transform -translate-y-1/2 -translate-x-1/2 xl:flex lg:mx-auto    xl:flex lg:items-center lg:w-auto lg:space-x-6">
        ...
        <li><a class="text-3xl text-black hover:text-[#f0a500]" href="./paylasilan-haberler.php">Paylaşılan Haberler</a>
        </li>
    ...
    <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-orange-50 border-r overflow-y-auto">
        ...
        <div>
            <ul>
                ...
                <li class="mb-1"><a
                            class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-[#f0a500] rounded"
                            href="./begeniler.php">Beğenilerim</a></li>
                <li class="mb-1"><a
                            class="block p-4 text-sm font-semibold text-gray-400 hover:bg-red-200 hover:text-[red] rounded"
...
<form class="mt-12" id="silForm" method="post" action="../db/crud/delete-comments.php">
    ...
    if ($data->num_rows > 0) {
        while ($row = $data->fetch_assoc()) {
            ...
            if ($eventId) {
                ...
                echo "<div class='px-[30rem] text-xl text-black flex flex-col justify-between items-center max-md:text-sm max-md:px-4'>
    ...
    echo "<div class='flex flex-row justify-center  '>
...
<form id="silReplyForm" method="post" action="../db/crud/delete-reply.php">
    <p class='my-4 text-4xl text-gray-500 flex justify-center items-center text-center lg:relative max-lg:text-lg'>YANITLAR</p>
...
echo "<div class='flex flex-row justify-center  '>
    <button id='topluYanitSilme' type='submit' name='silReply' class='p-2 rounded-2xl text-red-600 bg-red-100 hover:bg-red-200'
            disabled>Seçili Yanıtları Sil
    </button>
    </div>";
    $stmtReply->close();
    ?>
...
<div class="relative top-[1rem] left[45%]">
    <?php
